...
const BlogCard = ({ blog, typeFilter, searchParams }) => {
    ...
    return (
        <div
            key={blog.id}
            className=" w-[350px] overflow-hidden space-y-2 transform hover:scale-[1.02] duration-150 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
        >
