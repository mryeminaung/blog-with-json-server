...
const Navbar = () => {
    ...
    return (
        <nav className="bg-white border-gray-200 shadow-md shadow-slate-200 border dark:bg-gray-900">
            <div className="max-w-screen-2xl flex flex-wrap items-center  justify-between mx-auto p-5">
                ...
                <div
                    className={`flex items-center md:order-2 space-x-5 md:space-x-0 rtl:space-x-reverse`}
                >
                    {auth ? (
                        <>
